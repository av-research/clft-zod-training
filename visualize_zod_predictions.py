...
from utils.helpers import draw_test_segmentation_map, image_overlay, zod_anno_class_relabel, label_colors_list
    ...
    for frame_name in test_frames:
        try:
            ...
            if model is not None:
                ...
                # Run inference
                with torch.no_grad():
                    _, pred_logits = model(rgb_tensor, lidar_tensor, args.mode)
