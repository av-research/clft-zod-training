...
class DatasetPNG(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Crop the top part 1/2 of the input data (same as original)
        rgb_orig = rgb.copy()
        ...
        # For PNG data, we need to crop the PIL image accordingly
        top_crop_lidar = TF.crop(lidar_pil, delta, 0, h_orig-delta, w_orig)

        # Apply data augmentation directly to PIL images (PNG version)
        rgb_aug = top_crop_rgb
        anno_aug = top_crop_anno
        lidar_aug = top_crop_lidar
